...
class MementoTestCase(unittest.TestCase):
    ...
    def test_original_timemap(self):
        ...
        self.assertGreaterEqual(str(r.data).count('rel="memento"'), 0)
        self.assertGreaterEqual(str(r.data).count('rel="timemap"'), 0)
...
class TestFixture:
    ...
    def __init__(self, file):
        ...
        self.intermediate_timemaps =  config_parser.get('resources','intermediate_timemaps').split(',')
        self.intermediate_timegates = config_parser.get('resources','intermediate_timegates').split(',')
        self.intermediate_resources = config_parser.get('resources','intermediate_resources').split(',')
        self.mementos = config_parser.get('resources','mementos').split(',')
